...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-white w-full    ">
      ...
      <div className="flex flex-col  md:flex-row bg-purple-100 rounded-3xl md:w-[80%]  md:h-[500px]   justify-center mt-20  md:mt-40 p-3    ">
        <img
          src="https://cdn.prod.website-files.com/5ce10a4d0b5f0b560c22e756/667edcffb8e2be1ef70d2fc8_best-ai-website-generator.webp"
          className="md:w-1/2   "
        />
        <div className="flex flex-col md:w-1/2 flex-wrap text-2xl text-purple-800 md:p-15">
      ...
      <div className="flex  flex-col  md:flex-row bg-purple-100 rounded-3xl md:w-[80%]  md:h-[500px]   justify md:ml-80  mt-40 p-3 ">
      ...
      <div className="flex flex-row bg-purple-100 rounded-3xl md:w-[70%] h-[500px]    md:m-auto  mt-[150px] flex-wrap">
     <div className=" font-bold    bg-[url('https://www.shutterstock.com/shutterstock/videos/3834761799/thumb/4.jpg?ip=x480')] bg-cover bg-center rounded-3xl w-full justify-center items-center flex text-4xl md:text-6xl  text-purple-600 "> Content Library 
      <button
